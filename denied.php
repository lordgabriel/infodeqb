...
<div class="iq-page-header">
  <h1><i class="fas fa-lock fa-sm me-2 text-muted"></i><?= t('DENIED_TITLE') ?></h1>
</div>
...
<div class="alert alert-warning" role="alert">
  ...
  <a href="<?php echo htmlspecialchars($url_anterior); ?>" class="btn btn-sm btn-secondary ms-3 flex-shrink-0"><?= t('BACK') ?></a>
</div>
