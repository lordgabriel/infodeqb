...
require $_SERVER['DOCUMENT_ROOT'].'/deqwww.php';
...
$sth->execute(array($ticket));

// Define the Header/Footer before writing anything so they appear on the first page
$mpdf->SetHTMLHeader('<h1><div style="text-align: right;"><img src="'.HTTP_DIR.'/infodeqb/img/logo_deq_black.png" width="40%" ></div></h1><br><br><br>');
...
$id= $row['request_id'];
$data.= '<tr>'
		.'<td style="padding: 5px">'. $row['curso'] . '</td>'
...
$pdfcontent = '<body style="font-family: verdana; font-size: 9pt;"><h2><br><br>Auto de arquivo de elementos de avaliação</h2>
		<p style="font-size: 11 pt"><strong>Responsável:</strong> '. $docente.'</p>
		<p style="font-size: 11 pt"><strong>Id:</strong> '. $id.'</p>
